...
CREATE TABLE channel (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, name VARCHAR(50), description VARCHAR(50), start_time TIMESTAMP, is_active BOOLEAN, CONSTRAINT name_unique UNIQUE (name));
